...
# Exponential growth demographic function

def exp_growth(params, (n1), pts):
	T = params
	...
	nu=0.1 # initial population size
	nu_func = lambda t: nu*((1.0/nu)**(t/T)) # demographic function (exponential growth)
